...
if (user == null) {
	...
	if (user.getUserType().equals("admin")) {
		session.setAttribute("message", "You are  admin. You can't access user page");
...
<body class="container-center">
	...
	<div class="col-md-3">
		<div class="card -center text-white bg-dark mb-3" data-toggle="modal" data-target="#addproduct">
